local compile = require("__zk-lib__/lualib/moonscript/compile")
local parse = require("__zk-lib__/lualib/moonscript/parse")
...
dirsep = "/"
line_tables = require("__zk-lib__/lualib/moonscript/line_tables")
...
loadstring = function(...)
  ...
  chunk_name = chunk_name or "=(__zk-lib__/lualib/moonscript/loadstring)"
