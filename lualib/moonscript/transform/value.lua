...
local NameProxy
NameProxy = require("__zk-lib__/lualib/moonscript/transform/names").NameProxy
local Accumulator, default_accumulator
do
  local _obj_0 = require("__zk-lib__/lualib/moonscript/transform/accumulator")
  Accumulator, default_accumulator = _obj_0.Accumulator, _obj_0.default_accumulator
end
local lua_keywords
lua_keywords = require("__zk-lib__/lualib/moonscript/data").lua_keywords
local Run, transform_last_stm, implicitly_return, chain_is_stub
do
  local _obj_0 = require("__zk-lib__/lualib/moonscript/transform/statements")
...
construct_comprehension = require("__zk-lib__/lualib/moonscript/transform/comprehension").construct_comprehension
local insert
insert = table.insert
local unpack
