...
local types = require("__zk-lib__/lualib/moonscript/types")
...
local insert
insert = table.insert
local destructure = require("__zk-lib__/lualib/moonscript/transform/destructure")
...
return Transformer({
  ...
  class = require("__zk-lib__/lualib/moonscript/transform/class")
})
