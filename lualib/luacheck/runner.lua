local cache = require "__zk-lib__.lualib.luacheck.cache"
local config = require "__zk-lib__.lualib.luacheck.config"
local expand_rockspec = require "__zk-lib__.lualib.luacheck.expand_rockspec"
local format = require "__zk-lib__.lualib.luacheck.format"
local fs = require "__zk-lib__.lualib.luacheck.fs"
local globbing = require "__zk-lib__.lualib.luacheck.globbing"
local luacheck = require "luacheck"
local multithreading = require "__zk-lib__.lualib.luacheck.multithreading"
local options = require "__zk-lib__.lualib.luacheck.options"
local utils = require "__zk-lib__.lualib.luacheck.utils"
...
function Runner:_add_new_reports(inputs)
   ...
   local reports = map(__zk-lib__.lualib.luacheck.get_report, sources, self._top_opts.jobs)
...
function Runner:_get_final_report(reports)
   ...
   local final_report = __zk-lib__.lualib.luacheck.process_reports(reports, processing_options, self._config_stack:get_stds())

   -- `__zk-lib__.lualib.luacheck.process_reports` doesn't preserve `filename` fields, re-add them.
