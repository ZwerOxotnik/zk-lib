...
local profiler = require "__zk-lib__.lualib.luacheck.profiler"
local runner = require "__zk-lib__.lualib.luacheck.runner"
local utils = require "__zk-lib__.lualib.luacheck.utils"
local version = require "__zk-lib__.lualib.luacheck.version"
...
local function get_parser()
   local parser = argparse(
      "luacheck", "luacheck " .. __zk-lib__.lualib.luacheck._VERSION .. ", a linter and a static analyzer for Lua.", [[
Links:

   Luacheck on GitHub: https://github.com/mpeterv/luacheck
   Luacheck documentation: https://__zk-lib__.lualib.luacheck.readthedocs.org]])
      :help_max_width(80)
...
elseif type(err) == "string" and err:find("interrupted!$") then
   ...
   local msg = ("Luacheck %s bug (please report at https://github.com/mpeterv/luacheck/issues):\n%s\n%s"):format(
      __zk-lib__.lualib.luacheck._VERSION, err, traceback)
   critical(msg)
end
