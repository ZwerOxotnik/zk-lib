...
--[[--
 ...
 to override the core `table` locally:
      ...
      local table = require '__zk-lib__/lualib/std/table'
...
M = {
   ...
   -- @see merge_select
   -- @usage
   --    merge(_G, require '__zk-lib__/lualib/std/debug', {say='log'}, ':nometa')
   ...
   -- @see clone_select
   -- @usage
   --    merge_select(_G, require '__zk-lib__/lualib/std/debug', {'say'}, false)
