...
class = setmetatable({},{
    ...
    __index = function(tbl,key)
        if key == 'class' then
            log('require("__zk-lib__.lualib.Penlight.lua.pl.class").class is deprecated. Use require("__zk-lib__.lualib.Penlight.lua.pl.class")\n')
            return class
        end
        compat = compat or require '__zk-lib__.lualib.Penlight.lua.pl.compat'
