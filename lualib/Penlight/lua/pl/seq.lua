...
local callable = require '__zk-lib__.lualib.Penlight.lua.pl.types'.is_callable
...
function seq.copy(iter)
    ...
    setmetatable(res, require('__zk-lib__.lualib.Penlight.lua.pl.List'))
    return res
end
...
function seq.count_map(iter)
    ...
    return setmetatable(t, require('__zk-lib__.lualib.Penlight.lua.pl.Map'))
end
