...
local tonumber,ipairs,string,table =
    _G.tonumber,_G.ipairs,_G.string,_G.table
...
local splitv,assert_arg = utils.splitv,utils.assert_arg
...
local function makelist (res)
    return setmetatable(res, require('__zk-lib__.lualib.Penlight.lua.pl.List'))
end
