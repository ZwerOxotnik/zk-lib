--- A Map class.
--
--    > Map = require '__zk-lib__.lualib.Penlight.lua.pl.Map'
--    > m = Map{one=1,two=2}
...
local pretty_write = require '__zk-lib__.lualib.Penlight.lua.pl.pretty' . write
local Map = stdmt.Map
local Set = stdmt.Set

local class = require '__zk-lib__.lualib.Penlight.lua.pl.class'
...
local function makelist(t)
    return setmetatable(t, require('__zk-lib__.lualib.Penlight.lua.pl.List'))
end
