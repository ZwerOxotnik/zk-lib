...
local types = require ('__zk-lib__.lualib.Penlight.lua.pl.types')
...
local function setmeta (res,tbl,pl_class)
    local mt = getmetatable(tbl) or pl_class and require('__zk-lib__.lualib.Penlight.lua.pl.' .. pl_class)
...
local function makemap(m)
    return setmetatable(m, require('__zk-lib__.lualib.Penlight.lua.pl.Map'))
end
...
function tablex.makeset (t)
    assert_arg_indexable(1,t)
    return setmetatable(tablex.pairmap(set_op,t),require('__zk-lib__.lualib.Penlight.lua.pl.Set'))
end
