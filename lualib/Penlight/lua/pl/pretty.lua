...
local lexer = require '__zk-lib__.lualib.Penlight.lua.pl.lexer'
local quote_string = require '__zk-lib__.lualib.Penlight.lua.pl.stringx'.quote_string
...
--
--     print(require("__zk-lib__.lualib.Penlight.lua.pl.pretty").write({...}))
--
-- Can be shortened to:
--
--     require"pl.pretty" (...)
