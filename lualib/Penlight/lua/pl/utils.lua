...
local compat = require '__zk-lib__.lualib.Penlight.lua.pl.compat'
...
function utils.function_arg (idx,f,msg)
    ...
    if tp == 'string' then
        if not operators then operators = require '__zk-lib__.lualib.Penlight.lua.pl.operator'.optable end
...
--     "-lluacov",
--     "-e",
--     "utils = print(require('__zk-lib__.lualib.Penlight.lua.pl.utils')._VERSION",
-- }
