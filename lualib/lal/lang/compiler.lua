...
local Node     = require '__zk-lib__/lualib/lal/lang/codegen'
local utl      = require '__zk-lib__/lualib/lal/lang/util'
local Parser   = require '__zk-lib__/lualib/lal/lang/parser'
local List     = require '__zk-lib__/lualib/lal/util/list'
local class    = require '__zk-lib__/lualib/lal/util/class'

local support_bltins = require '__zk-lib__/lualib/lal/lang/builtins'
local support_syn    = require '__zk-lib__/lualib/lal/lang/syntax_forms'
local support_opt    = require '__zk-lib__/lualib/lal/lang/opt_builtins'
-----------------------------------------------------------------------------
...
function Compiler.to_builtin(func)
    return {
        sType     = "builtin",
        file      = "__zk-lib__/lualib/lal/lang/builtins",
        func      = func,
    }
end
-----------------------------------------------------------------------------
